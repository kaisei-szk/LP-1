...
<head>
  ...
  <style>
    ...
    body { font-family: 'Noto Sans JP', sans-serif; color: #333; background: #fafbff; }
    ...
    .hero-bg::after {
      ...
      background: url("data:image/svg+xml,%3Csvg viewBox='0 0 1440 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0,40 C480,60 960,20 1440,40 L1440,60 L0,60 Z' fill='%23fafbff'/%3E%3C/svg%3E") no-repeat bottom/cover;
    }

    /* ===== Marker underline ===== */
    .marker-yellow { background: linear-gradient(transparent 55%, #fff3c4 55%); padding: 0 2px; }
    .marker-blue { background: linear-gradient(transparent 55%, #dbeafe 55%); padding: 0 2px; }
    .marker-pink { background: linear-gradient(transparent 55%, #fce7f3 55%); padding: 0 2px; }

    /* ===== Speech bubbles ===== */
    .bubble-parent {
      background: #fff; border: 2px solid #bfdbfe; border-radius: 20px; padding: 18px 22px;
    ...
    .bubble-staff {
      background: #eff6ff; border: 2px solid #93c5fd; border-radius: 20px; padding: 18px 22px;
      position: relative; max-width: 85%;
    }
    .bubble-staff::after {
    ...
    .bubble-staff::before {
      ...
      border-left: 10px solid transparent; border-right: 10px solid transparent;
      border-top: 12px solid #eff6ff; z-index:1;
    }

    /* ===== Sections ===== */
    .bg-cream { background: #fafbff; }
    .bg-soft-green { background: linear-gradient(180deg, #eff6ff 0%, #fafbff 100%); }
    .bg-soft-yellow { background: linear-gradient(180deg, #fefce8 0%, #fafbff 100%); }
    .bg-soft-blue { background: linear-gradient(180deg, #eff6ff 0%, #fafbff 100%); }
    .bg-green-solid { background: #1d4ed8; }

    /* ===== Worry cards ===== */
    .worry-card {
      background: #fff; border-radius: 20px; padding: 24px 20px;
      border: 2px solid #dbeafe; text-align: center;
    ...
    .reason-card.rc-green::before { background: linear-gradient(90deg, #2563eb, #60a5fa); }
    ...
    /* ===== Big number ===== */
    .big-num { font-family: 'Zen Maru Gothic', sans-serif; font-weight: 900; color: #1d4ed8; line-height: 1; }
    ...
    .plan-card.recommended { border-color: #2563eb; box-shadow: 0 4px 20px rgba(37,99,235,.15); }
    ...
    /* ===== CTA Bands ===== */
    .cta-band-green { background: linear-gradient(135deg, #1e40af, #2563eb); }
    ...
    .faq-item:hover { border-color: #60a5fa; }
    ...
    .flow-step::after {
      ...
      width: 3px; background: #bfdbfe; border-radius: 2px;
    }
    ...
    .hdr-fixed {
      ...
      background: rgba(250,251,255,.95); backdrop-filter: blur(8px);
    ...
    .mentor-highlight {
      background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 40%, #f0f9ff 100%);
      border: 3px solid #2563eb; border-radius: 28px;
      position: relative; overflow: hidden;
    }
    .mentor-highlight::before {
      content: ''; position: absolute; top: -60px; right: -60px;
      width: 160px; height: 160px; background: rgba(37,99,235,.08); border-radius: 50%;
    }
  </style>
</head>
<body>
...
<header class="hdr-fixed">
  <div class="max-w-6xl mx-auto px-4 sm:px-6">
    <div class="flex items-center justify-between h-16">
      ...
      <nav class="hidden lg:flex items-center gap-5 text-[13px] font-bold text-gray-500">
        ...
        <a href="#how" class="hover:text-primary-600 transition">特長</a>
      ...
      <div class="ml-auto flex items-center gap-2">
        <div class="hidden md:flex items-center">
          <a href="#final-cta" class="text-xs font-bold bg-orange-500 hover:bg-orange-400 text-white rounded-full px-5 py-2.5 transition shadow-md shadow-orange-500/25">
            <i class="fas fa-calendar-check mr-1"></i>無料相談 30分
          </a>
        </div>
  ...
  <div id="mobMenu" class="hidden lg:hidden bg-white shadow-lg rounded-b-2xl mx-3 border border-primary-100">
    <div class="py-3 px-5 flex flex-col gap-1 text-sm font-bold text-gray-600">
      ...
      <a href="#how" class="mm-link py-2.5 hover:text-primary-600">特長</a>
      ...
      <div class="pt-2 mt-1 border-t">
        <a href="#final-cta" class="block text-center text-xs bg-orange-500 text-white font-bold py-2.5 rounded-lg">無料相談 30分</a>
      </div>
    </div>
  </div>
</header>
...
<!-- 01. HERO                                                      -->
<!-- ============================================================ -->
<section class="hero-bg pt-28 pb-32 md:pt-36 md:pb-44">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
    <div class="text-center reveal">
      <span class="inline-block bg-white/80 text-primary-700 font-round font-bold text-sm px-5 py-2 rounded-full mb-8 shadow-sm border border-primary-200">
        <i class="fas fa-stethoscope mr-1.5"></i>医学部受験専門 オンラインメンタリング
      </span>

      <h1 class="font-round font-black text-gray-800 mb-6" style="line-height:2.0">
        <span class="text-2xl sm:text-3xl lg:text-4xl">志望校合格までの</span><br>
        <span class="text-4xl sm:text-5xl lg:text-6xl text-primary-700">最短ルート</span><span class="text-2xl sm:text-3xl lg:text-4xl">を、</span><br>
        <span class="text-4xl sm:text-5xl lg:text-6xl">現役医学生</span><span class="text-2xl sm:text-3xl lg:text-4xl">と一緒に。</span>
      </h1>

      <p class="text-gray-500 text-base sm:text-lg leading-relaxed max-w-xl mx-auto mb-10">
        志望校から逆算して「やること・順番・量」を週ごとに設計。<br class="hidden sm:inline">
        30校以上・120名以上の医学生メンターが伴走します。
      </p>

      <div class="flex justify-center mb-12">
        <a href="#final-cta" class="cta-primary text-center justify-center text-lg py-5 px-10">
          <i class="fas fa-calendar-check"></i>まずは無料で相談する<span class="text-xs font-normal opacity-80 ml-2">（30分）</span>
        </a>
      </div>

      <div class="flex justify-center items-center gap-8 sm:gap-12">
        <div class="text-center">
          <p class="big-num text-4xl sm:text-5xl">30<span class="text-sm sm:text-base">校+</span></p>
          <p class="text-xs text-gray-400 mt-1">メンター所属大学</p>
        </div>
        <div class="w-px h-12 bg-primary-200"></div>
        <div class="text-center">
          <p class="big-num text-4xl sm:text-5xl">120<span class="text-sm sm:text-base">名+</span></p>
          <p class="text-xs text-gray-400 mt-1">登録メンター数</p>
        </div>
      </div>
    </div>
  </div>
...
<section id="worries" class="bg-soft-yellow py-16 md:py-20">
  <div class="max-w-5xl mx-auto px-4 sm:px-6">
    ...
    <div class="grid sm:grid-cols-2 gap-4 mb-10 reveal">
      <div class="worry-card">
        ...
        <p class="font-round font-bold text-gray-800 text-[15px] leading-snug">情報が多すぎて<br>何を信じればいいかわからない</p>
        <p class="text-xs text-gray-500 mt-2">塾・YouTube・参考書…方針が定まらない</p>
      </div>
      <div class="worry-card">
        ...
        <p class="font-round font-bold text-gray-800 text-[15px] leading-snug">計画を立てても崩れて<br>立て直せない</p>
        <p class="text-xs text-gray-500 mt-2">1日サボると全部が崩壊する…</p>
      </div>
      <div class="worry-card">
        <div class="w-12 h-12 mx-auto mb-3 bg-blue-50 rounded-full flex items-center justify-center">
          <i class="fas fa-chart-line text-blue-400 text-xl"></i>
        </div>
        <p class="font-round font-bold text-gray-800 text-[15px] leading-snug">勉強しているのに<br>成績が伸びない</p>
        <p class="text-xs text-gray-500 mt-2">やった気になるだけで結果に出ない…</p>
      </div>
      <div class="worry-card">
        ...
        <p class="font-round font-bold text-gray-800 text-[15px] leading-snug">同じミスを繰り返すが<br>原因がわからない</p>
        <p class="text-xs text-gray-500 mt-2">"ケアレスミス"で片付けてしまう…</p>
      </div>
    </div>
...
<div class="cta-band-green py-5">
  <div class="max-w-4xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-center gap-3">
    <p class="text-white font-round font-bold text-sm text-center">まずは30分、お子さまの状況を聞かせてください。</p>
...
<section class="bg-soft-blue py-20 md:py-28">
  <div class="max-w-4xl mx-auto px-4 sm:px-6">
    <div class="text-center reveal">
      ...
      <p class="font-round text-xl sm:text-2xl lg:text-3xl font-black text-primary-700 leading-[1.7] mb-8">
        その原因は「教わり方」ではなく<br>「考え方」にある。
      </p>
      <div class="w-16 h-0.5 bg-primary-200 mx-auto mb-8"></div>
      ...
      <div class="grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto mb-10">
        <div class="bg-white rounded-2xl py-6 px-4 text-center border-2 border-primary-100 shadow-sm">
          ...
          <p class="font-round font-bold text-gray-800 text-sm">自分で考える</p>
          <p class="text-gray-500 text-xs mt-1">「なぜ間違えたか」を<br>自分の言葉で言語化</p>
        </div>
        <div class="bg-white rounded-2xl py-6 px-4 text-center border-2 border-primary-100 shadow-sm">
          <div class="w-12 h-12 mx-auto mb-3 bg-primary-50 rounded-full flex items-center justify-center">
            <i class="fas fa-compass text-primary-600 text-xl"></i>
          </div>
          <p class="font-round font-bold text-gray-800 text-sm">自分で計画する</p>
          <p class="text-gray-500 text-xs mt-1">メンターと一緒に<br>「自分の戦略」を設計</p>
        </div>
        <div class="bg-white rounded-2xl py-6 px-4 text-center border-2 border-primary-100 shadow-sm">
          <div class="w-12 h-12 mx-auto mb-3 bg-primary-50 rounded-full flex items-center justify-center">
            <i class="fas fa-sync-alt text-primary-600 text-xl"></i>
          </div>
          <p class="font-round font-bold text-gray-800 text-sm">自分で修正する</p>
          <p class="text-gray-500 text-xs mt-1">毎週振り返り<br>改善サイクルを回す</p>
        </div>
      </div>
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 text-center">
    <div class="reveal">
      ...
      <p class="text-gray-600 text-sm leading-relaxed max-w-2xl mx-auto">
        全国<strong class="text-primary-700">30校以上</strong>の医学部に在籍する<strong class="text-primary-700">120名以上</strong>の現役医学生メンターが、<br class="hidden sm:inline">あなたが「自分で考えて動ける」ようになるまで伴走します。
      </p>
    </div>

    <!-- Before/After -->
    <div class="relative grid md:grid-cols-2 gap-6 items-stretch mt-10 reveal">
      <div class="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-white rounded-full shadow-lg items-center justify-center z-20 pointer-events-none">
      ...
      <div class="bg-red-50 rounded-3xl p-7 border-2 border-red-200 text-left">
        ...
        <ul class="space-y-4">
          <li class="flex gap-3 items-start"><i class="fas fa-frown text-coral-400 mt-0.5"></i><p class="text-sm text-gray-700">言われたことをやるだけで<strong>自分で考えていない</strong></p></li>
          <li class="flex gap-3 items-start"><i class="fas fa-frown text-coral-400 mt-0.5"></i><p class="text-sm text-gray-700">計画が崩れても<strong>自分で立て直せない</strong></p></li>
          <li class="flex gap-3 items-start"><i class="fas fa-frown text-coral-400 mt-0.5"></i><p class="text-sm text-gray-700">ミスの原因を<strong>自分で分析できない</strong></p></li>
        </ul>
      </div>
      <div class="bg-blue-50 rounded-3xl p-7 border-2 border-primary-200 text-left">
        <div class="flex items-center gap-2 mb-5">
        ...
        <ul class="space-y-4">
          ...
          <li class="flex gap-3 items-start"><i class="fas fa-smile text-primary-500 mt-0.5"></i><p class="text-sm text-gray-700">崩れても<strong class="text-primary-700">自分で修正できる力</strong>が身につく</p></li>
          <li class="flex gap-3 items-start"><i class="fas fa-smile text-primary-500 mt-0.5"></i><p class="text-sm text-gray-700">ミスを<strong class="text-primary-700">自分で分類・対策</strong>できるようになる</p></li>
        </ul>
      </div>
    </div>
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6">
    <div class="text-center mb-5 reveal">
      ...
      <h2 class="font-round text-2xl sm:text-3xl font-black text-gray-800 leading-tight">
        ...
        <span class="font-round font-black text-2xl sm:text-3xl text-gray-800">つの<span class="marker-blue">秘密</span></span>
      </h2>
    </div>
      ...
      <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm">
        <div class="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <h3 class="font-round font-black text-xl text-gray-800"><span class="marker-blue">逆算設計</span>が万全</h3>
          </div>
        </div>
      ...
      <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm">
        <div class="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <h3 class="font-round font-black text-xl text-gray-800">面談日以外の<span class="marker-blue">サポートが万全</span></h3>
          </div>
        </div>
...
<section id="plans" class="bg-soft-green py-16 md:py-20">
  <div class="max-w-5xl mx-auto px-4 sm:px-6">
    <div class="text-center mb-4 reveal">
      ...
      <h2 class="font-round text-2xl sm:text-3xl font-black text-gray-800">お得な<span class="marker-blue">料金プラン</span></h2>
    ...
    <div class="grid md:grid-cols-3 gap-5 reveal">
      <div class="plan-card text-center flex flex-col h-full">
        ...
        <p class="font-round font-black text-4xl text-gray-800 mb-5 min-h-[56px]"><span class="text-sm font-medium text-gray-400">税込</span> &#165;29,800<span class="text-sm font-medium text-gray-400">/月</span></p>
        <ul class="text-sm text-gray-600 space-y-3 text-left mb-6">
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>Zoom面談 月2回</li>
        ...
        <a href="#final-cta" class="mt-auto block bg-gray-100 hover:bg-gray-200 text-gray-600 font-bold text-sm py-3.5 rounded-full transition font-round min-h-[44px] flex items-center justify-center">まずは無料相談</a>
      </div>
      <div class="plan-card recommended text-center relative flex flex-col h-full">
        ...
        <p class="font-round font-black text-4xl text-primary-700 mb-5 min-h-[56px]"><span class="text-sm font-medium text-gray-400">税込</span> &#165;54,800<span class="text-sm font-medium text-gray-400">/月</span></p>
        <ul class="text-sm text-gray-700 space-y-3 text-left mb-6 font-medium">
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>Zoom面談 月4回</li>
      ...
      <div class="plan-card text-center flex flex-col h-full">
        ...
        <p class="font-round font-black text-4xl text-gray-800 mb-5 min-h-[56px]"><span class="text-sm font-medium text-gray-400">税込</span> &#165;118,000<span class="text-sm font-medium text-gray-400">/月</span></p>
        <ul class="text-sm text-gray-600 space-y-3 text-left mb-6">
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>Zoom面談 月4回（長めの面談あり）</li>
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>週次伴走サイクル</li>
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>優先チャット＋解説サポート</li>
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>小論文・記述の添削</li>
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>面接対策</li>
          <li class="flex gap-2"><i class="fas fa-check text-primary-500 mt-0.5"></i>平日毎日の学習報告フォロー</li>
        </ul>
        <a href="#final-cta" class="mt-auto block bg-gray-100 hover:bg-gray-200 text-gray-600 font-bold text-sm py-3.5 rounded-full transition font-round min-h-[44px] flex items-center justify-center">まずは無料相談</a>
      </div>
    </div>
...
<section id="flow" class="bg-soft-yellow py-16 md:py-20">
  <div class="max-w-4xl mx-auto px-4 sm:px-6">
    ...
    <div class="reveal flex justify-center">
      <div class="space-y-0 w-full max-w-xl">
      <div class="flow-step flex gap-5 items-start pb-8 w-fit mx-auto">
        ...
        <div class="pt-1.5 text-left w-[280px] sm:w-[360px]">
          <p class="font-round font-bold text-gray-800 text-lg">無料相談（30分）</p>
      ...
      <div class="flex gap-5 items-start w-fit mx-auto">
  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
    <div class="reveal">
      ...
      <p class="text-gray-600 text-base mb-8">
        ...
        <strong class="text-primary-700">無料相談はもちろん無料。無理な勧誘はありません。</strong>
      </p>

      <!-- 3 support summary -->
      <div class="grid sm:grid-cols-3 gap-4 mb-10 max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl py-5 px-3 text-center border-2 border-primary-100 shadow-sm">
          <div class="w-12 h-12 mx-auto mb-2 bg-primary-50 rounded-full flex items-center justify-center">
            <i class="fas fa-drafting-compass text-primary-600 text-xl"></i>
          </div>
          <p class="font-round font-bold text-gray-800 text-sm">逆算設計が<br>万全</p>
        </div>
        <div class="bg-white rounded-2xl py-5 px-3 text-center border-2 border-primary-100 shadow-sm">
          <div class="w-12 h-12 mx-auto mb-2 bg-primary-50 rounded-full flex items-center justify-center">
            <i class="fas fa-user-graduate text-primary-600 text-xl"></i>
          </div>
          <p class="font-round font-bold text-gray-800 text-sm">相性ピッタリの<br>メンター</p>
        </div>
        <div class="bg-white rounded-2xl py-5 px-3 text-center border-2 border-primary-100 shadow-sm">
          <div class="w-12 h-12 mx-auto mb-2 bg-primary-50 rounded-full flex items-center justify-center">
            <i class="fas fa-comment-dots text-primary-600 text-xl"></i>
          </div>
          <p class="font-round font-bold text-gray-800 text-sm">面談日以外の<br>サポートが万全</p>
        </div>
      </div>
    </div>
...
<div class="mobile-bar">
  <a href="#final-cta" class="flex-1 flex items-center justify-center bg-orange-500 text-white font-round font-bold text-sm py-3.5 rounded-xl shadow-lg shadow-orange-500/25">
    <i class="fas fa-calendar-check mr-2 text-xs"></i>無料相談 30分
  </a>
</div>
